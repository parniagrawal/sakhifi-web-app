...
export declare namespace GeoFirestoreTypes {
     ...
     */
    interface DocumentChange<T = GeoDocumentData> {
     ...
     * 'undefined'.
     */
    interface QueryDocumentSnapshot<T = GeoDocumentData> {
        /**
     ...
     */
    type WhereFilterOp = firebase.firestore.WhereFilterOp | cloudfirestore.WhereFilterOp;
    namespace web {
        /**
    ...
    namespace cloud {
         ...
         * Defines configuration options for the Remote Config SDK.
         */
        type Settings = cloudfirestore.Settings;
        /**
         * A reference to a transaction.
         * The `Transaction` object passed to a transaction's updateFunction provides
         * the methods to read and write data within the transaction context. See
