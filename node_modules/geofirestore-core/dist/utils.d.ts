...
export declare const CUSTOM_KEY = "coordinates";
 ...
 */
export declare function generateQuery(query: GeoFirestoreTypes.cloud.Query | GeoFirestoreTypes.web.Query, queryCriteria: GeoFirestoreTypes.QueryCriteria): GeoFirestoreTypes.web.Query[];
/**
 ...
 */
export declare function stringToQuery(str: string): string[];
/**
 ...
 */
export declare function queryToString(query: string[]): string;
/**
